        ...
        <?php if(loggedIn()):?>
          <div class="collapse navbar-collapse" id="ftco-nav">
	        <ul class="navbar-nav ml-auto">
	          <li class="nav-item active"><a href="/admin/property" class="nav-link">Property</a></li>
	          <li class="nav-item"><a href="/admin/createproperty" class="nav-link">Create Property</a></li>
        ...
        <?php else:?>
          <div class="collapse navbar-collapse" id="ftco-nav">
	        <ul class="navbar-nav ml-auto">
	          ...
	          <li class="nav-item"><a href="/listing" class="nav-link">Listing</a></li>
